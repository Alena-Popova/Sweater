...
import org.popova.lesson.sweater.domain.dto.CaptchaResponseDto;
...
public class RegistrationController {
    ...
    public String addUser(
       ...
       /* String url = String.format(RECAPTCHA_URL, secret, captchaResponse);
    ...
    public String activate(Model model, @PathVariable String code) {
        boolean isActivated = userSevice.activareUser(code);
        if (isActivated) {
            model.addAttribute("messageType", "success");
            model.addAttribute("message", "Activation code is success");
        } else {
